    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-9 align-self-center fh5co_mediya_right">
                ...
                @if(!Auth::user())
                <div class="text-center d-inline-block pull-right">
                    <a href="{{ route('login') }}" target="_blank" class="fh5co_display_table"><div class="fh5co_verticle_middle">Login<i class="fa fa-user"></i> </div></a>
                </div>
                <div class="text-center d-inline-block pull-right">
                    <a href="{{ route('register') }}" target="_blank" class="fh5co_display_table"><div class="fh5co_verticle_middle">Register<i class="fa fa-user-plus"></i>  </div></a>
                </div>
                @else
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    @foreach($categories as $category)
                        ...
                        @else
                            <li class="nav-item ">
                                <a class="nav-link" href="single.html">{{ $category->name }} <span class="sr-only">(current)</span></a>
                            </li>
                        @endif
                    @endforeach
        ...
        <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
            <div class="fh5co_suceefh5co_height"><img src="{{ asset('images/'.$new->image) }}" alt="img"/>
                ...
                <div class="fh5co_suceefh5co_height_position_absolute_font">
                    ...
                    <div class=""><a href="single.html" class="fh5co_good_font"> {!! substr(strip_tags($new->body), 0, 70) !!}{{ strlen(strip_tags($new->title))>20 ? "..." : ""}} </a></div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
                ...
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="{{ asset('images/'.$list->image) }}" alt="img"/>
                        ...
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            ...
                            <div class=""><a href="single.html" class="fh5co_good_font_2">  {!! substr(strip_tags($list->body), 0, 70) !!}{{ strlen(strip_tags($list->title))>20 ? "..." : ""}} </a></div>
                        </div>
                    </div>
                </div>
                @endforeach
...
<div class="container-fluid pt-3">
    <div class="container animate-box" data-animate-effect="fadeIn">
        ...
        <div class="owl-carousel owl-theme js" id="slider1">
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    ...
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="single.html" class="text-white"> {!! substr(strip_tags($list->title), 0, 70) !!}{{ strlen(strip_tags($list->title))>20 ? "..." : ""}} </a>
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_latest_trading_img"><img src="{{ asset('images/ryan-moreno-98837.jpg') }}" alt="" class="fh5co_img_special_relative"/></div>
                    <div class="fh5co_latest_trading_img_position_absolute"></div>
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="single.html" class="text-white"> Here's a new way to take better photos for instagram </a>
                        <div class="fh5co_latest_trading_date_and_name_color"> Walter Johson - March 7,2017</div>
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_latest_trading_img"><img src="{{ asset('images/science-578x362.jpg') }}" alt="" class="fh5co_img_special_relative"/></div>
                    <div class="fh5co_latest_trading_img_position_absolute"></div>
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="single.html" class="text-white"> Here's a new way to take better photos for instagram </a>
                        <div class="fh5co_latest_trading_date_and_name_color"> Walter Johson - March 7,2017</div>
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_latest_trading_img"><img src="{{ asset('images/nick-karvounis-78711.jpg') }}" alt="" class="fh5co_img_special_relative"/></div>
                    <div class="fh5co_latest_trading_img_position_absolute"></div>
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="single.html" class="text-white"> Here's a new way to take better photos for instagram </a>
                        <div class="fh5co_latest_trading_date_and_name_color"> Walter Johson - March 7,2017</div>
                ...
                @foreach($value as $post)
                    <div class="item px-2">
                        <div class="fh5co_hover_news_img">
                            ...
                            <div>
                                <a href="single.html" class="d-block fh5co_small_post_heading"><span class="">{!! substr(strip_tags($post->title), 0, 20) !!}{{ strlen(strip_tags($post->title))>20 ? "..." : ""}}</span></a>
            ...
            @foreach($newList as $post)
                <div class="row pb-4">
                    ...
                    <div class="col-md-7 animate-box">
                        <a href="single.html" class="fh5co_magna py-2"> {!! substr(strip_tags($post->title), 0, 20) !!}{{ strlen(strip_tags($post->title))>20 ? "..." : ""}}</a> <a href="single.html" class="fh5co_mini_time py-3"> Thomson Smith -
                        April 18,2016 </a>
